...
const sampleGames: Game[] = [
  ...
  { id: uuidv4(), title: 'Kemet', maxPlayers: 5, link: 'https://boardgamegeek.com/boardgame/297562/kemet-blood-and-sand', image: 'https://cf.geekdo-images.com/IU-az-0jlIpoUxDHCCclNw__imagepagezoom/img/JUuxRLpu0aOMPWbSMxNj4KuT0eA=/fit-in/1200x900/filters:no_upscale():strip_icc()/pic6230640.jpg' },
  { id: uuidv4(), title: 'The Magnificent', maxPlayers: 4, link: 'https://boardgamegeek.com/boardgame/283863/the-magnificent', image: 'https://cf.geekdo-images.com/6pci74DWc7U7XuwkfpEu2Q__imagepagezoom/img/mMhV7GS5YfNRDjQ2reRjsIm6_vY=/fit-in/1200x900/filters:no_upscale():strip_icc()/pic4871117.jpg' },
  ...
  { id: uuidv4(), title: 'Great Western Trail', maxPlayers: 4, link: 'https://boardgamegeek.com/boardgame/193738/great-western-trail', image: 'https://cf.geekdo-images.com/u1l0gH7sb_vnvDvoO_QHqA__imagepagezoom/img/cJyIiNTccBaE7UjYIsP2c-nkssE=/fit-in/1200x900/filters:no_upscale():strip_icc()/pic4887376.jpg' },
...
const samplePlayers: Player[] = [
  { id: uuidv4(), name: 'Jonny', icon: '🐯', selectionsMade: 0, picks: [sampleGames[3].id, sampleGames[10].id], actionTakenInCurrentRound: false, optedOutOfRound: false },
  { id: uuidv4(), name: 'Jourdan', icon: '🐼', selectionsMade: 0, picks: [sampleGames[0].id, sampleGames[7].id], actionTakenInCurrentRound: false, optedOutOfRound: false },
  { id: uuidv4(), name: 'Chris', icon: '🦁', selectionsMade: 0, picks: [sampleGames[5].id, sampleGames[12].id], actionTakenInCurrentRound: false, optedOutOfRound: false },
  { id: uuidv4(), name: 'Matthew', icon: '🦊', selectionsMade: 0, picks: [sampleGames[1].id, sampleGames[8].id], actionTakenInCurrentRound: false, optedOutOfRound: false },
  { id: uuidv4(), name: 'Felipe', icon: '🐻', selectionsMade: 0, picks: [sampleGames[4].id, sampleGames[11].id], actionTakenInCurrentRound: false, optedOutOfRound: false },
  { id: uuidv4(), name: 'Paul', icon: '🦉', selectionsMade: 0, picks: [sampleGames[6].id, sampleGames[13].id], actionTakenInCurrentRound: false, optedOutOfRound: false },
  { id: uuidv4(), name: 'Cam', icon: '🐺', selectionsMade: 0, picks: [sampleGames[2].id, sampleGames[9].id], actionTakenInCurrentRound: false, optedOutOfRound: false },
];
